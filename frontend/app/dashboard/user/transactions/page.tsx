...
import { Search, Receipt, ArrowUpRight, ArrowDownLeft } from "lucide-react";
...
//  search by reference number, and pagination.
// ─────────────────────────────────────────────────────
...
const typeColors: Record<string, string> = {
  toll: "bg-blue-500/10 text-blue-600",
  topup: "bg-emerald-500/10 text-emerald-600",
  refund: "bg-violet-500/10 text-violet-600",
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Your complete toll and payment history
        </p>
      </div>
